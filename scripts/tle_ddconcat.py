...
ap.add_argument("-o", "--output", help="Output .npz filename. Default is T{{E1}}_{{E2}}.npz", default=None)
ap.add_argument("-d", "--directory", help="Directory to use for ALL files.", default="./tle")
